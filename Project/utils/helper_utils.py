...
def visualize_block_division(original_image, block_size):
    """Visualize block division by drawing boundaries around blocks."""
    ...
    plt.title("Block Division Visualization")
    plt.axis('off')
    plt.show()
